...
class AppPallete {
  ...
  static const Color card = Color(0xFF1C2B3A); // cards, list tiles
  static const Color cardAlt1 = Color(0xFF1A2744);
  static const Color cardAlt2 = Color(0xFF1E3050);
  static const Color elevated = Color(
    0xFF2A3348,
  ); // modals, dialogs (slightly lifted)
